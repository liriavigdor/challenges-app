...
export const FireIcon = ({ size = 24, fill = "none", className = "" }) => (
...
export const TrophyIcon = ({ size = 24, className = "" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M12 2a6 6 0 0 1 6 6v3.58a6 6 0 0 1-3.69 5.5l-.81.33c-.96.39-2.04.39-3 0l-.81-.33A6 6 0 0 1 6 11.58V8a6 6 0 0 1 6-6Z" />
  </svg>
);
...
export const MedalIcon = ({ size = 24, className = "" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M7.21 15 2.66 7.14a2 2 0 0 1 .13-2.2L4.4 2.8A2 2 0 0 1 6 2h12a2 2 0 0 1 1.6.8l1.6 2.14a2 2 0 0 1 .14 2.2L16.8 15" />
    <path d="M12 15a4 4 0 1 0 0 8 4 4 0 0 0 0-8Z" />
    <path d="m10.5 18.5 1 1.5 2-2" />
  </svg>
);
